...
?>
            ...
            <head>
                ...
                <title>NS Paradise - Buy Now</title>
                            ...
                            <div class="row justify-content-center mt-5">
                                ...
                                <div class="col-12 col-sm-10 col-md-6 col-lg-4">
                                    <div class="row justify-content-center gy-2">
                                        ...
                                        <div class="col-12">
                                            <label class="form-label fw-bold fs-4 text-danger">Rs. <?php echo $product["price"]; ?> .00</label>
                                        </div>
                                        ...
                                        <div class="col-10 d-grid mt-3">
                                            <button class="btn btn-warning text-white fw-bold fs-5" onclick="BuyNow(<?php echo $product['id']; ?>);">Proceed to Pay</button>
                                        </div>
