...
?>
    ...
    <head>
        ...
        <title>NS Paraside - CheckOut</title>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="row bg-primary py-3">
                        ...
                        <div class="col-12 text-center">
                            <h1 class="fw-bolder fs-1 text-white">CHECKOUT</h1>
                        </div>
                            ...
                            <div class="col-10 col-sm-8 col-md-6 col-lg-4">
                                <div class="row">
                                    ...
                                    <div class="col-12 d-grid">
                                        <button class="btn btn-warning text-white fw-bold fs-4" onclick="CheckOut();">Proceed to Pay</button>
                                    </div>
                ...
                ?>
                    ...
                    <div class="col-12 text-center my-5">
                        <span class="fs-1 text-danger fw-bold">There are no Items in your Cart</span>
                    </div>
