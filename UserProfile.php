...
?>
    ...
    <head>
        ...
        <title>NS Paradise | User Profile</title>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                $user = Database::search("SELECT * FROM `customer` WHERE `email` = '" . $_SESSION["user"]["email"] . "'");
                ...
                ?>
                    ...
                    <div class="col-12">
                        <div class="row justify-content-center mt-3 rounded bg-light">


                            <div class="col-sm-10 col-md-6 col-lg-3 border-end border-dark">
                                <div class="row mt-3" style="text-align: center;">
                                    <?php
                                    $profile_rs = Database::search("SELECT * FROM `profile_image` WHERE `customer_email` = '" . $_SESSION["user"]["email"] . "'");
                                    ...
                                    ?>
                                        <div class="col-12">
                                            <img src="<?php echo $profile["path"]; ?>" id="prev" class="img-thumbnail rounded-circle" width="150px" height="150px" />
                                        </div>
                                        <div class="col-12 mt-3">
                                            <span role="button" tabindex="0" class="text-danger" onclick="RemovePic();">Remove Photo</span>
                                            <br />
                                            <input type="file" accept="img/*" class="form-control d-none" id="profile" />
                                ...
                                <div class="row g-2 p-2 justify-content-center">
                                    ...
                                    ?>
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $verification["status"]; ?>" disabled />
                                        </div>
                                    <?php
                                    } else {
                                    ?>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <?php
                                        $reg_date = $user_deatail["registration_date"];
                                    ...
                                    $address = Database::search("SELECT * FROM `customer_has_address` WHERE `customer_email` = '" . $_SESSION["user"]["email"] . "'");
                                    ...
                                    ?>
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $city["postalcode"]; ?>" placeholder="Enter Your Postal Code..." id="postalcode" />
                                        </div>
                                        <div class="col-12 col-lg-6">
                                    ...
                                    <div class="col-12 col-sm-10 col-md-8 col-lg-6 d-grid my-3">
                                        <button class="btn btn-secondary fs-4 fw-bold" onclick="UpdateProfile();">Update Profile</button>
                                    </div>
